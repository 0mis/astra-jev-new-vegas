...
- Jev completed Doc Mitchell's opening and discharge, crossed Goodsprings, entered the Prospector Saloon, spoke with Sunny Smiles and completed her bottle-shooting lesson. It then reached the water source and progressed through the first gecko fight with Sunny. The active objective is clearing geckos at the other wells. Suggested Guns, Sneak and Speech tags were accepted before the broader autonomy policy was introduced. General combat, later menus and the main-story ending remain unverified.
